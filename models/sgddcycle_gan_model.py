...
#        self.feat_loss_BrecB = self.criterionFeat(self.netFeat(self.real_B), self.netFeat(self.rec_B)) * lambda_feat_BrecB 
        ...
        # combined loss
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_G_A1 + self.loss_G_B1 + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.feat_loss +self.loss_SynA + self.loss_SynB + self.loss_CSA + self.loss_CSB
